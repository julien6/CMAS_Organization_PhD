...
\begin{frame}{}
  ...
  \noindent {\tiny \begin{spacing}{0.8}
      \textit{Soulé, J., Jamont, J.-P., Occello, M., Traonouez L.-M., Théron, P. (2025). \textquote{Assisting Multi-Agent System Design with $\mathcal{M}OISE^+$ and MARL : The MAMAD Method}. In : Journal of Autonomous Agents and Multi-Agent Systems (JAAMAS) (2025).}
    \end{spacing}}
...
\begin{frame}{Selected Results for Cyber-Defense Environments (2/2)}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{table}[h!]
        \centering
        \caption*{Multi-metric summary for the \textit{Microservices K8s} env.}
