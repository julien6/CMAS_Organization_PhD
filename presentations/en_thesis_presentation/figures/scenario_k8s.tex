...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    % Text Node
    \draw (278.5,1654.5) node  [font=\small] [align=left] {bottleneck};
    % Text Node
    \draw (208.5,1654.5) node  [font=\small] [align=left] {crash};
    % Text Node
    \draw (146,1603.45) node  [font=\small] [align=left] {defenders};
    % Text Node
    \draw (51,1353.45) node  [font=\small] [align=left] {attacker};
    % Text Node
    ...
    % Text Node
    \draw (579,1514.45) node  [font=\small] [align=left] {operational resilience};
    % Text Node
    \draw (90.71,1409.45) node  [font=\small] [align=left] {input};
    % Text Node
    \draw (124,1550.5) node  [font=\small] [align=left] {\textit{scaling actions}};
    % Text Node
