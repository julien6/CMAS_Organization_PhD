...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    % Text Node
    \draw (108,1334.5) node  [font=\tiny] [align=left] {flatten predicted joint-observation};
    % Text Node
    ...
    % Text Node
    \draw (409.5,1315.5) node  [font=\tiny] [align=left] {recurrent hidden state};
    % Text Node
    \draw (404,1334.5) node  [font=\tiny] [align=left] {flatten joint-action};
    % Text Node
    \draw (270,1315.5) node  [font=\tiny] [align=left] {flatten joint-observation};
    % Text Node
    \draw (538,1334.5) node  [font=\tiny] [align=left] {joint-action};
    % Text Node
    \draw (83,1316.5) node  [font=\tiny] [align=left] {joint-observation};
    % Text Node
