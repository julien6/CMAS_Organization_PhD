...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1.2,xscale=1.2]
    ...
    % Text Node
    \draw (244,52.5) node  [font=\normalsize] [align=left] {{\tiny Actions}};
    \draw (244,58.5) node  [font=\normalsize] [align=left] {{\tiny mise à}};
    \draw (244,64.5) node  [font=\normalsize] [align=left] {{\tiny l'échelle}};
    % Text Node
    \draw (244,99.5) node  [font=\normalsize] [align=left] {{\tiny Données}};
    \draw (244,105.5) node  [font=\normalsize] [align=left] {{\tiny métriques}};
    % Text Node
    ...
    \draw (296.4,72.5) node  [font=\tiny,color={rgb, 255:red, 0; green, 0; blue, 0 }  ,opacity=1 ] [align=left] {Composant\\Transfert};
    % Text Node
    ...
    \draw (389.38,39.96) node  [font=\tiny,color={rgb, 255:red, 0; green, 0; blue, 0 }  ,opacity=1 ] [align=left] {Composant\\Analyse};
    % Text Node
    ...
    \draw (389.38,108.74) node  [font=\tiny,color={rgb, 255:red, 0; green, 0; blue, 0 }  ,opacity=1 ] [align=left] {Composant\\Entraînement};
    % Text Node
    ...
    \draw (296.4,109.5) node  [font=\tiny,color={rgb, 255:red, 0; green, 0; blue, 0 }  ,opacity=1 ] [align=left] {Composant\\Modélisation};
    % Text Node
