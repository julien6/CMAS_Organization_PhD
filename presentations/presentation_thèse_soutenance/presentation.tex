...
\begin{frame}{Transfert / Déploiement}
  ...
  \begin{columns}
    ...
    \begin{column}{0.6\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=.9\linewidth]{figures/transfert_algo.png}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}{Synthèse et contributions}
  \begin{itemize}
    \item Une méthode de conception de SMA appliqué pour Cyberdéfense
          \begin{itemize}
            \item Modélisation (simulations manuelles ou world models)
            \item Entraînement sous contraintes (MOISE+MARL)
            \item Analyse organisationnelle émergente (TEMM / Auto-TEMM)
            \item Transfert vers le réel
          \end{itemize}
          \vspace{0.1cm}
    \item Contributions associées
          \begin{itemize}
            \item Extension multi-agent des world models
            \item Intégration MOISE+ dans le MARL
            \item Méthode d’analyse des comportements (roles, missions)
            \item Implémentation logicielle unifiée
          \end{itemize}
          \vspace{0.1cm}
    \item Expérimentations sur trois environnements
          \begin{itemize}
            \item Résilience + Adaptation + Autonomie
            \item Meilleurs compromis performance / contrôle
            \item Meilleure lisibilité des comportements émergents
          \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Perspectives}
  \begin{itemize}
    \item Ouvertures à court et moyen terme
          \begin{itemize}
            \item Modélisation enrichie
                  → Intégration de connaissances expertes, hybridation data + symbolique
            \item Apprentissage plus robuste
                  → Environnements dynamiques, adversaires adaptatifs, sim2real continu
            \item Analyse organisationnelle avancée
                  → Rôles et objectifs explicites + inférence structurelle automatisée
          \end{itemize}
          \vspace{0.1cm}
    \item Problématiques long terme
          \begin{itemize}
            \item Passage à l’échelle (clusters, réseaux réels)
            \item Interopérabilité avec architectures existantes (SOC, CSIRT)
            \item Acceptabilité humaine et explicabilité opérationnelle
            \item Déploiement hybride simulation/réel
          \end{itemize}
  \end{itemize}
\end{frame}
