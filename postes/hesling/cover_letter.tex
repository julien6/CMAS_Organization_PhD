...
In industry, my work focused on the cyber-resilience of safety-critical military telecommunication systems, managing network traffic under quality-of-service constraints. In academic case studies, I explored \textbf{IoT}-inspired case studies ranging from enterprise network infrastructures to drone swarms and warehouse management systems. This work provided me with a solid technical background across the full stack of \textbf{MARL}, primarily developing in \textbf{Python} (as well as \textbf{Rust} and \textbf{Java} in Thales-related projects) using frameworks such as \textbf{PyTorch} and \textbf{TensorFlow}, together with RL/MARL libraries including \textbf{PettingZoo/Gym}, \textbf{MARLlib/RLlib}, \textbf{Jax/JaxMARL}, and \textbf{Optuna} for high-performance experimentation. I am used to managing large-scale experimental workflows using high-performance computing infrastructures (such as the academic \href{https://gricad-doc.univ-grenoble-alpes.fr/en/}{\textbf{Gricad}} HPC platform), alongside software engineering practices including \textbf{Git}. Over time, I have come to view research and engineering not as separate activities, but as complementary aspects of building reliable autonomous systems.


Throughout my PhD, I was exposed to a rich international research environment, spanning both academia and industry (notably \textbf{Thales Germany}), and contributed to the dissemination of our research in top-tier conferences and journals such as \href{https://arxiv.org/abs/2503.23615}{\textbf{(AAMAS~2025)}} and \href{https://assets-eu.researchsquare.com/files/rs-7166037/v1_covered_908e23dd-6fb8-4efc-9ef3-a78c4d539bac.pdf?c=1753863562}{\textbf{(JAAMAS~2025, under 2nd-round revision)}}.
This experience has strengthened my ability to communicate and collaborate within interdisciplinary teams.

At this stage of my career, I am motivated to contribute to autonomous decision-making systems where reinforcement learning is not an end in itself, but a core component of operationally deployed, safety-critical technology. The \textbf{Centaur} project aligns strongly with my interest in robust autonomous decision-making for adversarial, time-critical aerial environments, bridging large-scale simulation and real-world deployment.
