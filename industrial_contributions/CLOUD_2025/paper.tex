...
% TODO: This analysis phase is aimed to improve the generalizability of KARMA not relying too much on the designer's experience as for domain specific knowledge to define roles and goals -> This phase enables getting insight of "ideal" roles and "goals" considering that emerging "abstract" roles and goals are what appear to be the most efficient indepently objectively.
% We can use it as an automated roles and goals generation proceeding as follow : 1) we start the training phase with limited roles and goals or roles and goals having little restriction; 2) after this training, we apply the analysis method to get insights of "abstract" roles and missions
