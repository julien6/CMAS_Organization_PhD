...
\setbeamertemplate{footline}{
  ...
  \scriptsize%
  \ifnum\value{framenumber}>17%
    Appendix \number\numexpr\value{framenumber}-15\relax/32%
  \else%
    \ifnum\value{framenumber}>15%
      %
    \else
      \number\numexpr\value{framenumber}\relax/15%
    \fi
...
\begin{frame}{Phase 2: Training (Constrained/Guided MARL)}{The MOISE+MARL framework}
...
\begin{frame}{Phase 3: Analyzing Agent Behaviors}{The TEMM method overview}
