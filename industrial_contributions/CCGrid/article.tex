...
\begin{itemize}
    ...
    The availability in Kubernetes can be defined as the capability of a cluster to efficiently handle user requests while meeting predefined Quality of Service (QoS) contracts.
    $$
