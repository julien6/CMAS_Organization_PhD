...
%   - roles
%   - goals (missions)
%   - HPA MAS (produits durant la phase d'entrainement) + introduire le concept de HPA MAS durant l'introduction
%   - Trouver une fonction de récompense qui évalue la disponibilité pour inclure tous les QoS
%   - Faire que chaque QoS devienne un un objectif associé à un fonction de récompense spécifique
%   - Trouver des règles d'action pour constituer des rôles pour chacun des objectifs
