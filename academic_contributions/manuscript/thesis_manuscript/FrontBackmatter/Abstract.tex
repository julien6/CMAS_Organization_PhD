...
We validated our method through three case studies: a drone swarm, a corporate infrastructure, and a micro-architecture scenario. The results demonstrate effectiveness in simulation, particularly in terms of adaptability, autonomy, and resilience, compared to centralized Cyberdefense systems. However, since simulation cannot capture the full complexity of real systems, the effectiveness of such SMA when transferred to real-world environments is diminished.
