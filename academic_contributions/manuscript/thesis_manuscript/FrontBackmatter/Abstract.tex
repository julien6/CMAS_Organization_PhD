...
\begin{otherlanguage}{ngerman}
    ...
    Pour combler cet écart, nous utilisons des techniques d'identification des systèmes pour générer des modèles de simulation plus réalistes.
...
To bridge this gap, we use system identification techniques to generate more realistic simulation models.
