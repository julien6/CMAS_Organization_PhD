...
We summarize our evaluation criteria into the \Autoref{tab:evaluation_criteria}:

\begin{table}[h!]
    \centering
    \begin{tabular}{|>{\centering\arraybackslash}m{0.2\textwidth}|>{\centering\arraybackslash}m{0.7\textwidth}|}
        \hline
        \textbf{Qualitative Evaluation} & \textbf{Description} \\
        \hline
        $(\mathbf{C_1})$ & After training, we expect to manually notice collective hunting strategies, such as circling prey, under the \textit{circle\_model} in visually rendered environment. \\
        \hline
        \textbf{Quantitative Evaluation} & \textbf{Description} \\
        \hline
        $(\mathbf{C_2})$ & We expect faster convergence in the PTS case compared to the NTS case, with the FTS case showing a constant learning curve. \\
        \hline
        $(\mathbf{C_3})$ & We expect higher rewards in the PTS case compared to the NTS case. \\
        ...
        \hline
    \end{tabular}
    \caption{Evaluation criteria divided into qualitative and quantitative parts.}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
        ...
        \hline
        Criteria & NTS & PTS & FTS & NTS & PTS & FTS & NTS & PTS & FTS \\
        \hline
        ...
        Constraint Respect & No & Yes & Yes & Partial & Yes & Yes & Yes & Yes & Yes \\
        \hline
    \end{tabular}
    \caption{Comparison of NTS, PTS, and FTS cases under different modes (correct, penalize, correct\_policy) based on various criteria.}
    \label{tab:results}
\end{table}
...
\footnotetext[2]{A visual animated representation is provided in \url{https://drive.google.com/file/d/1idIs59_7mXhVSavxELPMFxH1W6TKhYrb/view?usp=sharing}}
