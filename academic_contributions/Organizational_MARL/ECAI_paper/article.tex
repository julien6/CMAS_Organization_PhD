...
\footnotetext[1]{Details for proof outlines and the case studies are provided in the appendix with the developed code in the attached zip file of this paper}
