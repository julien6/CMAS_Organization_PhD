...
Un SMA est fortement lié à l'entité de l'organisation (nous appelons simplement \textbf{organisation}) nous considérons qu'elle existe toujours à travers les interactions des agents en cours d'exécution même s'elle peut être implicite.
%
