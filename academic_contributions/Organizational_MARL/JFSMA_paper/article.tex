...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/prahom_learning_curve.png}
...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/prahom_pca_analysis.png}
