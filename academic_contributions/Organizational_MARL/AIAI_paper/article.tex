...
These aforementioned methods are commonly applied through simulations because they enable a safe monitoring framework for the design process and assessment. A MAS developed in simulated environments with high fidelity to the target system are expected to be transferred to the target system to perform adequately~\cite{Schon2021}.
