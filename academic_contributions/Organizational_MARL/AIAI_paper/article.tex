    ...
    \ForEach{$1 \leq ep \leq ep_{max}$}{
        ...
        \ForEach{$1 \leq step \leq step_{max}$}{
            ...
            \ForEach{$\pi_i \in \pi_{joint}$}{
                ...
                $A_{step} = \{a | (\omega_{step}, a) \in \pi, \pi \in \pi_{joint},\pi_{joint} not \in forbidden, \{(\omega', a') \in h\} \in \pi\}$ \Comment*[r]{Restricted available actions}
