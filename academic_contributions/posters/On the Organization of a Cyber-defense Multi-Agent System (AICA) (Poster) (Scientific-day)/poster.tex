...
\begin{frame}[t]
    ...
    \begin{columns}[t]
        ...
        \begin{column}{\colwidth}
            ...
            \begin{variableblock}{Cyber-defense MAS Review}{bg=lightgray,fg=black}{bg=lightgray,fg=black}
            ...
            \begin{variableblock}{Objectives}{bg=lightorange,fg=black}{bg=lightorange,fg=black}
        ...
        \begin{column}{\colwidth}
            ...
            \begin{variableblock}{Solving research focus}{bg=lightorange,fg=black}{bg=lightorange,fg=black}

                \headingNoLine{Concern}: Iterative Design Process of Multi-Agent System (MAS) costly
                \begin{itemize}
                ...
                \headingNoLine{Partial Relation Between Agents' Histories and Organizational Models}:
                \begin{itemize}
            ...
            \begin{variableblock}{Implementation research focus}{bg=lightorange,fg=black}{bg=lightorange,fg=black}
                ...
                \headingNoLine{Implementing solving as a library:} we proposed the \textit{PRAHOM Wrapper}:
                ...
                \begin{table}[h]
                    ...
                    \begin{tabular}{cc} % Two columns
                        ...
                        \makecell{
                        \includegraphics[width=0.18\linewidth]{figures/moving_company_v0.png}} \\
                    \end{tabular}
                    % \caption{Two-column table with images}
                    % \label{tab:images}
                \end{table}
            ...
            \begin{variableblock}{Perspectives}{bg=lightgray,fg=black}{bg=lightgray,fg=black}
                \begin{itemize}
                    \item Use of Large Language Models for better XAI
                    \item Emulation improvement \& System identification
                    \item Industrial \& Academical case studies
                \end{itemize}
            \end{variableblock}
