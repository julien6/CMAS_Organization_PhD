...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    % Text Node
    \draw (120,1334.5) node  [font=\tiny] [align=left] {predicted flatten joint-observation};
    % Text Node
    \draw (38.5,1333.5) node  [font=\tiny] [align=left] {$\displaystyle \widetilde{\hat{\omega }}_{t}$};
    % Text Node
    \draw (555,1316.5) node  [font=\tiny] [align=left] {latent representation\\of the joint-observation};
    % Text Node
    \draw (412,1315.5) node  [font=\tiny] [align=left] {hidden recurrent state};
    % Text Node
    \draw (408,1334.5) node  [font=\tiny] [align=left] {flatten joint-action};
    % Text Node
    \draw (270,1315.5) node  [font=\tiny] [align=left] {flatten joint-observation};
    % Text Node
    \draw (536,1334.5) node  [font=\tiny] [align=left] {joint-action};
    % Text Node
    \draw (92.5,1316.5) node  [font=\tiny] [align=left] {joint-observation};
    % Text Node
    ...
    % Text Node
    \draw (295.56,1110.97) node  [color={rgb, 255:red, 65; green, 117; blue, 5 }  ,opacity=1 ] [align=left] {{\footnotesize \textbf{Autoencoder}}};
    % Text Node
