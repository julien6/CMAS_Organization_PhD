...
%
In a multi-agent context, world modeling must accommodate decentralized dynamics~\cite{Gronauer2022}. Then, then observable dynamics function treats joint-observation (as well as joint latent representation) and joint-action. In MAMAD, world models instantiate the simulation core of \hyperref[sec:modelling]{Modeling}, acting as digital twins.
