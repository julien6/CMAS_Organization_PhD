...
\draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (250,962) -- (259.81,962) -- (259.81,974) -- (250,974) -- cycle ;
%Straight Lines [id:da11132308874086716] 
\draw    (337.87,968) -- (343.73,968) -- (355.12,968) ;
\draw [shift={(357.12,968)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (4.37,-1.96) .. controls (2.78,-0.92) and (1.32,-0.27) .. (0,0) .. controls (1.32,0.27) and (2.78,0.92) .. (4.37,1.96)   ;
\draw [shift={(335.87,968)}, rotate = 0] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (4.37,-1.96) .. controls (2.78,-0.92) and (1.32,-0.27) .. (0,0) .. controls (1.32,0.27) and (2.78,0.92) .. (4.37,1.96)   ;
...
% Text Node
\draw (384,966) node  [font=\footnotesize] [align=left] {\begin{minipage}[lt]{29.67pt}\setlength\topsep{0pt}
\begin{center}
{\small Relation}
\end{center}
...
\end{minipage}};
% Text Node
\draw (290,966) node  [font=\footnotesize] [align=left] {\begin{minipage}[lt]{35.37pt}\setlength\topsep{0pt}
\begin{center}
{\small Ensemble}
\end{center}
