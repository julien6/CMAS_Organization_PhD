...
Pour une spécification déontique $(\rho,m,t_c)$ appliquée à un seul agent, ce dernier est contraint à un rôle $\rho \in mathcal{R}$ et est permis ou autorisé à s'engager à une mission, la fonction de valeur $V^\pi$ a la forme suivante :
