...
\begin{figure*}[h!]
  \label{eq:maximize_function}
  \centering
  \begin{align}
    V^\pi(s_t) = \sum_{\substack{
  ...
  \text{with } rag(\omega_t) = A_{t+1} \times \mathbb{R} = ach, \ ach(a_{t+1}) = ch_{t+1} ; { and } $rn: \emptyset \to [0,1]$, a uniform random function.
  \end{align}  
\end{figure*}
