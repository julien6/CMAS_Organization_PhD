...
\begin{frame}{Résultats}
    \begin{itemize}
        ...
        \item Par exemple, dans l'environnement **Predator-Prey**, le score de correspondance organisationnelle a augmenté de 44% avec MOISE+MARL.
...
\begin{frame}{Comparaison avec AGR+MARL}
    \begin{itemize}
        ...
        \item **MOISE+MARL** montre une amélioration substantielle des performances, avec des gains jusqu'à 33% dans le niveau de correspondance organisationnelle.
