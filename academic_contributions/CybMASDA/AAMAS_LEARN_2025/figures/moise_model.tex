...
% Text Node
\draw (362.13,969) node  [font=\footnotesize] [align=left] {\begin{minipage}[lt]{29.67pt}\setlength\topsep{0pt}
\begin{center}
{\small Relation}
\end{center}
...
% Text Node
\draw (239.38,881) node   [align=left] {$\displaystyle \mathcal{Gr}$};
% Text Node
