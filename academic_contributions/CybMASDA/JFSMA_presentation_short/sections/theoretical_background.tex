...
%                         {\small
%                             Processus de Décision Markovien Partiellement Observable Décentralisé (Dec-POMDP)~\parencite{Oliehoek2016}
%                             \begin{itemize}
...
%                                 \item la fonction de récompense est commune aux agents, ce qui favorise l'entraînement pour des actions orientées vers la collaboration~\parencite{Beynier2013}
%                             \end{itemize}
%                         }
%                         \
