...
\begin{frame}{Introduction}{Répondre aux lacunes}
    ...
    \begin{table}[]
        ...
        \begin{tabular}{@{}ccc
            ...
            \textbf{(G1)}                                                                                                                                                                    &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{34FF34} \begin{tabular}[c]{@{}c@{}}\small Trouver politiques\\ \small adaptées automatiquement\end{tabular}}                            &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{FE0000} \small Pas méthode automatisée}                                                                                                 &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} }                                                                                                                                  &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{34FF34} \begin{tabular}[c]{@{}c@{}c@{}}\small Trouver politiques\\ \small adaptées automatiquement\\ \small \phantom{XXX}\end{tabular}}&
                                                                                                                                                                                             &
            \\

            \textbf{(G2)}                                                                                                                                                                    &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{FE0000} \begin{tabular}[c]{@{}c@{}}\small Pas schéma de\\ \small organisation explicite\end{tabular}}                      &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{34FF34} \begin{tabular}[c]{@{}c@{}}\small Formaliser organisation\\ \small implicite en \\ \small Spécs. Org.\end{tabular}} &
