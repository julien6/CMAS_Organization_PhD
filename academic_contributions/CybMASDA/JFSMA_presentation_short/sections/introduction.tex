...
\begin{frame}{Introduction}{Contexte de la Conception des SMA}
    ...
    \begin{center}
        \begin{minipage}{0.95\linewidth}
            \centering
            \begin{exampleblock}{Agents de Cyberdéfense Autonomes et Intelligents~\cite{Kott2023} (AICA)}
...
\begin{frame}{Introduction}{Répondre aux lacunes}
    ...
    \begin{table}[]
        ...
        \begin{tabular}{@{}ccc
            ...
            \textbf{(G1)}                                                                                                                                                                    &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{046E11} \begin{tabular}[c]{@{}c@{}}\small Trouver politiques\\ \small adaptées automatiquement\end{tabular}}                            &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{FE0000} \small Pas méthode automatisée}                                                                                                 &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} }                                                                                                                                  &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{046E11} \begin{tabular}[c]{@{}c@{}c@{}}\small Trouver politiques\\ \small adaptées automatiquement\\ \small \phantom{XXX}\end{tabular}}&
                                                                                                                                                                                             &
            \\
