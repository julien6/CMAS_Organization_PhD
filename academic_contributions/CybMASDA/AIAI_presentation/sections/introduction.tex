...
\begin{frame}{Introduction}{Problème}
    ...
    \begin{exampleblock}{Lacunes ciblées}
        \begin{enumerate}
...
\end{frame}
\begin{frame}{Introduction}{Répondre aux lacunes}

    \begin{alertblock}{Lacunes ciblées}
        \begin{enumerate}
            \item[\phantom{X} (G1)] \textbf{Automatiser la recherche de politiques d’agents adaptées respectant les contraintes de conception};
    ...
    \begin{table}[]
        ...
        \begin{tabular}{@{}ccc
            ...
            \textbf{(G1)}                                                                                                                                                                    &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{34FF34} \begin{tabular}[c]{@{}c@{}}\small Trouver des\\ \small politiques adaptées automatiquement\end{tabular}}                            &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{FE0000} \small Pas de méthode automatisée}                                                                                                 &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} }                                                                                                                                  &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{34FF34} \begin{tabular}[c]{@{}c@{}c@{}}\small Trouver des\\ \small politiques adaptées automatiquement\\ \small \phantom{XXX}\end{tabular}}&
                                                                                                                                                                                             &
            \\

            \textbf{(G2)}                                                                                                                                                                    &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{FE0000} \begin{tabular}[c]{@{}c@{}}\small Pas de schéma de\\ \small coopération/organisation explicite\end{tabular}}                      &
            \cellcolor[HTML]{FFFFFF}{\color[HTML]{34FF34} \begin{tabular}[c]{@{}c@{}}\small Formaliser l'organisation\\ \small implicite en tant que\\ \small Spécifications Organisationnelles\end{tabular}} &
