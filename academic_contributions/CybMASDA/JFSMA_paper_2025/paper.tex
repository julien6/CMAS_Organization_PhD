...
\motscles{Apprentissage par renforcement multi-agent, Explicabilité, Contrôle}
...
\end{abstract}
\keywords{Multi-Agent Reinforcement Learning, Explainability, Control}
