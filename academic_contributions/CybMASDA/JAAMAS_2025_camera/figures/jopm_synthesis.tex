...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    % Text Node
    \draw (282,1334.5) node  [font=\tiny] [align=left] {approximated joint-observation};
    % Text Node
    \draw (206.5,1335) node  [font=\tiny] [align=left] {$\displaystyle \hat{\omega }_{t}$};
    % Text Node
    \draw (120,1334.5) node  [font=\tiny] [align=left] {flatten predicted joint-observation};
    % Text Node
    \draw (38.5,1333.5) node  [font=\tiny] [align=left] {$\displaystyle \widetilde{\hat{\omega }}_{t}$};
    % Text Node
    \draw (555,1316.5) node  [font=\tiny] [align=left] {latent representation\\of joint-observation};
    % Text Node
    \draw (413.5,1315.5) node  [font=\tiny] [align=left] {recurrent hidden state};
    % Text Node
    \draw (406,1334.5) node  [font=\tiny] [align=left] {flatten joint-action};
    % Text Node
    \draw (268.5,1315.5) node  [font=\tiny] [align=left] {flatten joint-observation};
    % Text Node
    \draw (537,1334.5) node  [font=\tiny] [align=left] {joint-action};
    % Text Node
    \draw (85.5,1316.5) node  [font=\tiny] [align=left] {joint-observation};
    % Text Node
    ...
    % Text Node
    \draw (295.56,1110.97) node  [color={rgb, 255:red, 65; green, 117; blue, 5 }  ,opacity=1 ] [align=left] {{\footnotesize \textbf{Auto-encoder}}};
    % Text Node
