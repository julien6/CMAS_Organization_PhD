...
J'ai également participé à différents encadrements : projets de première et deuxième année en école d'ingénieur (programmation C, Cybersécurité), accompagnement d'étudiants en projets d'analyse ou simulation, suivi d'avancement et participation aux évaluations orales. Ces encadrements permettent d'aborder les difficultés dans un cadre moins formel que les cours et de discuter des méthodes de travail et stratégies de résolution de problèmes.
...
\begin{landscape}
    ...
    \begin{longtable}{%
        ...
        $\sim 20$                                                                                                                               &
        TD                                                                                                                                      &
        Encadrement de séances de travaux dirigés à partir de supports existants, accompagnement des étudiants et participation à l’évaluation. &
        Attestation ESISAR                                                                                                                        \\
        ...
        $\sim 25$                                                                                                                               &
        TD                                                                                                                                      &
        Encadrement de séances de travaux dirigés pour étudiants ingénieurs, aide méthodologique et suivi des acquis.                           &
        Attestation ESISAR                                                                                                                        \\
        ...
        $\sim 25$                                                                                                                               &
        TP                                                                                                                                      &
        Encadrement de travaux pratiques (programmation système, processus, mémoire), accompagnement technique et évaluation continue.          &
        Attestation ESISAR                                                                                                                        \\
        ...
        $\sim 20$                                                                                                                               &
        TP                                                                                                                                      &
        Encadrement de séances de TP pour étudiants ingénieurs de 3e année, assistance technique et validation des livrables.                   &
        Attestation ESISAR                                                                                                                        \\
    ...
    \begin{longtable}{%
        ...
        $\sim 20$                                                                                                                                                           &
        TD/TP                                                                                                                                                               &
        Encadrement de séances portant sur l’administration système et la virtualisation, accompagnement technique des étudiants et évaluation des acquis.                  &
        ...
        $\sim 30$                                                                                                                                                           &
        TD/TP                                                                                                                                                               &
        Encadrement de séances de travaux dirigés et pratiques sur la structuration de données et le traitement de l’information, suivi pédagogique et évaluation continue. &
        Attestation IUT Valence                                                                                                                                               \\
        ...
        $\sim 25$                                                                                                                                                           &
        TD/TP                                                                                                                                                               &
        Encadrement de séances de programmation système (processus, mémoire, appels système), aide méthodologique et validation des travaux.                                &
        Attestation IUT Valence                                                                                                                                               \\
    \end{longtable}
...
Forte de mon parcours à l’interface entre SMA, MARL, et Cyberdéfense, je me sens prêt à assurer des enseignements dans ces domaines, auprès de publics variés allant du premier cycle universitaire aux élèves ingénieurs et masters. Je peux intervenir sur les thématiques suivantes :
\begin{itemize}
    \item \textbf{SMAs} () : fondements, modélisation organisationnelle, applications (niveau licence, master, école d’ingénieur) ;
    \item \textbf{Apprentissage par renforcement (mono- et multi-agent)} : principes, algorithmes, applications à la robotique et à la cybersécurité ;
    ...
    \item \textbf{Projets pratiques et études de cas} : conception et encadrement de mini-projets, travaux dirigés et travaux pratiques, intégrant des environnements simulés ou réels.
\end{itemize}
Mon expérience d’enseignement, acquise en école d’ingénieur, en IUT (ainsi qu'au sein de Thales), me permet d’adapter les contenus et méthodes pédagogiques à différents niveaux et profils d’étudiants. Je souhaite également contribuer à la création de modules transversaux reliant systèmes, IA distribuée et sécurité informatique, et à l’intégration d’activités pratiques avancées pour favoriser l’autonomie et l’acquisition de compétences appliquées.
...
Mes activités de recherche se sont développées principalement dans le cadre de ma thèse CIFRE au LCIS (Grenoble INP -- UGA, Valence) et chez Thales Land and Air Systems, au sein de l’entité \textquote{La Ruche} à Rennes. Elles se situent à l’interface entre systèmes multi-agents, apprentissage automatique (en particulier l’apprentissage par renforcement multi-agent) et Cybersécurité. La nature des travaux est à la fois méthodologique (modélisation organisationnelle, définition de cadres d’analyse) et expérimentale (simulation, évaluation de comportements dans des scénarios de Cyberdéfense).

\subsubsection*{Thématiques, lieux et nature des activités}

Les activités menées s’organisent autour de trois axes principaux :
\begin{itemize}
    \item \textbf{Intégration de modèles organisationnels dans le MARL} : conception et étude d’architectures permettant d’injecter des contraintes issues du modèle $\mathcal{M}OISE^+$ dans des algorithmes d’apprentissage multi-agent, en s’appuyant sur des expériences conduites au LCIS et chez Thales.
    \item \textbf{Analyse de comportements et d’organisations émergentes} : développement de méthodes et d’outils pour extraire, représenter et interpréter les organisations effectivement adoptées par les agents après apprentissage (module \textit{TEMM}).
    \item \textbf{Simulation de scénarios de Cyberdéfense} : construction d’environnements de simulation (coopératifs et adversariaux) permettant de tester des stratégies de détection et de réaction dans des contextes distribués, en lien avec des cas d’usage identifiés avec Thales.
\end{itemize}
...
Les travaux menés pendant la thèse ouvrent plusieurs perspectives que je souhaite poursuivre autour de l’apprentissage multi-agent, de la modélisation organisationnelle et de la cybersécurité. À court terme, il s’agira surtout de consolider les outils développés, en particulier l’intégration de MOISE+ au MARL et les modules d’analyse comme TEMM, ainsi que d’étendre les environnements d’expérimentation afin d’étudier des situations plus variées et dynamiques. Ce travail vise à stabiliser un socle méthodologique et logiciel capable de soutenir des études plus approfondies.
...
%
\begin{multicols}{2}
    \begin{enumerate}[leftmargin=*, itemsep=-2pt, topsep=0pt, label=\arabic*.]
...
\begin{itemize}[leftmargin=1.5em]
    \item[\textbf{\textcolor{SectionColor}{1.}}] \begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
            \item[] \textbf{Titre} : \textquote{Une approche organisationnelle pour améliorer l’explicabilité et le contrôle dans l’apprentissage par renforcement multi-agent}
...
\begin{itemize}[leftmargin=1.5em]
    \item[\textbf{\textcolor{SectionColor}{2.}}] \begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
            ...
            \item[] \textbf{DOI} : \href{https://www.doi.org/10.48550/arXiv.2503.23615}{10.48550/arXiv.2503.23615}
            \item[] \textbf{Ma contribution} : 1, 2, 3, 5, 6, 9, 11, 12, 13, 14
        \end{itemize}
...
\begin{enumerate}[leftmargin=1.5em]
    ...
    \item \begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
              \item[] \textbf{Sujet} : Relectures pour les conférences AAMAS (1 revue), ICAART (3 revues), SMC (2 revues) et ICDL (1 revue) ainsi que JFSMA (2 revues) et RESSI (1 revue)
    ...
    \item \begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
              \item[] \textbf{Sujet} : Trésorier du groupe AICA IWG (International Work Group)
              \item[] \textbf{Lieu} : En ligne
    ...
    \item \begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
              ...
              \item[] \textbf{Résultat} : La journée a réuni une cinquantaine de doctorants autour de présentations scientifiques (orales et posters) le matin, suivies d’activités sportives l’après-midi. En tant que co-organisateur, j’ai participé à la définition du programme scientifique, à la recherche et la réservation des lieux, à l’organisation logistique (traiteur, activités, budget), au choix de la date et à la communication auprès des participants.
          \end{itemize}
