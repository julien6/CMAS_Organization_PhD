...
\begin{center}
    ...
    Candidature à la qualification CNU 27 — Informatique\\[4pt]
    \vspace{0.5cm}
\end{center}
...
\begin{itemize}[leftmargin=1.2cm]
    ...
    \item \textbf{Téléphone personnel} : 06 77 63 12 13
    \item \textbf{Téléphone professionnel} : 04 56 52 99 81
    \item \textbf{Courriel institutionnel} : \href{mailto:julien.soule@univ-grenoble-alpes.fr}{julien.soule@univ-grenoble-alpes.fr}
    \item \textbf{Courriel personnel} (optionnel) : \href{mailto:julien.soule.pro@gmail.com}{julien.soule.pro@gmail.com}
    \item \textbf{Pages scientifiques} :
          \begin{itemize}
              ...
              \item ORCID (si applicable) : \url{https://orcid.org/}
          \end{itemize}
...
Les travaux issus de cette thèse ont donné lieu à plusieurs publications, dont un article soumis à JAAMAS et une série de contributions en conférences internationales et nationales.
...
\begin{itemize}[leftmargin=1.2cm]
    \item \textbf{Cours magistraux (CM)} : 2 h
...
\subsubsection*{Grenoble INP -- ESISAR}

\begin{center}
    \begin{tabular}{p{2.4cm} p{4.2cm} p{3cm} p{3cm}}
        \toprule
        \textbf{Année} & \textbf{Module}                                 & \textbf{Niveau} & \textbf{Volume}                  \\
        \midrule
        2024--2025     & 3AMIN333 : Systèmes d’exploitation              & 1A Ingénieur    & 1.75 h TD + 15.75 h TD + 21 h TP \\
        2023--2024     & 3AMOS302 : Systèmes d’exploitation              & 3A Ingénieur    & 9 h TP                           \\
        2023--2024     & 5AMPX511 : Veille technologique / cybersécurité & 5A Ingénieur    & 2 h TD                           \\
        \bottomrule
    \end{tabular}
\end{center}

\subsubsection*{IUT de Valence}

\begin{center}
    \begin{tabular}{p{2.4cm} p{4.2cm} p{4.2cm} p{2.5cm}}
        \toprule
        \textbf{Année} & \textbf{Formation}  & \textbf{Module}                              & \textbf{Volume} \\
        \midrule
        2022--2023     & BUT R\&T 1A         & Administration système et virtualisation     & 7.5 h eqTD      \\
        2024--2025     & BUT GEA 1A          & Structuration et traitement de l’information & 24 h eqTD       \\
        2024--2025     & BUT Informatique 2A & Programmation système                        & 16.5 h eqTD     \\
        \bottomrule
    \end{tabular}
\end{center}
...
Le parcours présenté dans ce rapport reflète la continuité entre les différentes activités menées au cours de ces dernières années, qu’il s’agisse de recherche, d’enseignement ou de participation à la vie collective du laboratoire. La thèse a constitué un cadre privilégié pour explorer des questions liées aux systèmes multi-agents, à l’apprentissage et à la modélisation de comportements dans des environnements complexes, tout en conservant un lien étroit avec des besoins issus du monde industriel. Les travaux réalisés s’inscrivent ainsi dans un ensemble d’approches où se croisent modélisation formelle, simulation et apprentissage automatique.

Les activités d’enseignement menées à l’ESISAR et à l’IUT de Valence ont permis de développer une expérience pédagogique diversifiée, en particulier autour des systèmes d’exploitation, de la programmation et de la cybersécurité. Elles ont contribué à consolider un intérêt pour la transmission et ont renforcé la volonté de poursuivre un parcours associant recherche et formation des étudiants.

L’ensemble de ces éléments trouve naturellement sa place dans les thématiques de la section~27, qui couvre un spectre large allant des fondements des systèmes informatiques aux approches d’intelligence artificielle distribuée. Les travaux menés pendant la thèse, les développements logiciels associés et les perspectives de recherche décrites s’inscrivent dans cette dynamique et ouvrent la voie à un programme de travail cohérent pour les années à venir.

Ce rapport constitue ainsi un bilan des activités engagées dans le cadre du doctorat et une première étape vers la poursuite d’un parcours d’enseignant-chercheur dans le domaine des systèmes intelligents et distribués.
...
\begin{itemize}[leftmargin=1.2cm]
    ...
    \item \textbf{Tableaux récapitulatifs} : synthèse des heures d’enseignement sous forme d’équivalents TD, accompagnée des détails par établissement et par type de séance (CM, TD, TP).
