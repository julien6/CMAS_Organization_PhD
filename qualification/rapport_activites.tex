...
Les travaux issus de cette thèse ont donné lieu à plusieurs publications composées de deux journaux, quatre conférences internationales et six conférences nationales.
...
\begin{itemize}
    \item \textbf{Intitulé} : Ingénieur en informatique
    \item \textbf{Dates} : 1er septembre 2015 -- 1er janvier novembre 2021
    \item \textbf{Etablissement d’accueil} : INSA Rennes
