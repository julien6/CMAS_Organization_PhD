...
\begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
    ...
    \item[] \textbf{Pages scientifiques} :
        \begin{itemize}[leftmargin=*, itemsep=-2pt, topsep=0pt]
            ...
            \item arXiv : \url{https://arxiv.org/a/soule_j_1.html}
            \item HAL : \url{https://hal.science/search/index?q=authIdHal_i%3A1623409}
...
\noindent
J'ai entrepris une thèse au sein du LCIS, rattaché à Grenoble-INP -- UGA, entre 2022 et 2025. Ce travail s'inscrit dans une convention CIFRE avec Thales LAS, ce qui m'a permis d'évoluer à la fois dans un environnement académique et dans un contexte industriel fortement orienté vers les problématiques de Cyberdéfense.
%
...
\noindent
Durant mon doctorat, j'ai assuré des enseignements en tant que vacataire. A l'école d'ingénieur Grenoble-INP -- Esisar, j'ai enseigné pour un total de \textbf{49.50 hEqTD} au cours de séances de Travaux Pratiques (TP), de séances de Travaux Dirigés (TD) pour des étudiants ingénieurs de niveau variant entre première et cinquième années. À l'IUT de Valence, pour un total de \textbf{48 hEqTD}, j'ai enseigné des séances de TP pour des étudiants en Bachelor Universitaire de Technologie (BUT) de première et deuxième années, principalement sur des thématiques liées aux systèmes d'exploitation, à la programmation système et à la structuration de l'information.
...
\begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
    ...
    \item[] \textbf{Statut} Salarié CDI (1 an 1 mois)
\end{itemize}
...
\noindent
Dès le début de ma thèse, j'ai assuré différents enseignements au sein de l'école d'ingénieur Grenoble-INP -- Esisar et de l'IUT de Valence.
Le \autoref{tab:enseignement-esisar} et le \autoref{tab:enseignement-iut} reprennent les informations concernant les enseignements que j'ai réalisés respectivement à l'école d'ingénieur Grenoble-INP -- Esisar et à l'IUT de Valence. Le volume horaire total effectué est présentée dans le \autoref{tab:enseignement-total}\footnote{Les volumes horaires sont données en hEqTD et les effectifs en nombre d'étudiants, le produit $n \times x$ signifie la responsabilité de $x$ groupes de $n$ étudiants.}.
Les valeurs suivantes correspondent aux heures attestées sur la période 2022--2025 incluant les enseignements \textbf{Nature}. Les années d'exercice correspondent aux années scolaires: \textbf{TD} : 19,5h (Grenoble-INP -- Esisar) ; \textbf{TP} : 30h (Grenoble-INP -- Esisar) + 18h (IUT).
...
\begin{itemize}[leftmargin=1.5em, itemsep=-2pt, topsep=0pt]
    \item \textbf{Fondamentaux} : algorithmique et structures de données (analyse de complexité, algorithmes classiques, graphes),
          programmation impérative, orientée objet, fonctionnelle et web
          (\texttt{C}, \texttt{C++}, \texttt{Java}, \texttt{Python}, \texttt{OCaml},
          frameworks JavaScript),
          génie logiciel (cycle de vie, patrons, tests, gestion de versions),
          bases de données (modélisation, modèle relationnel, SQL, NoSQL), mathématiques pour l'informatique (logique, probabilités discrètes, algèbre linéaire, complexité) ;
    \item \textbf{SMA} : fondements, modélisation, applications (niveau licence, master, école d'ingénieur) ;
    \item \textbf{RL et MARL} : principes, algorithmes, applications à la robotique et à la cybersécurité ;
    \item \textbf{Cybersécurité} : introduction, détection d'anomalies, sécurité des systèmes distribués ;
    \item \textbf{Programmation système et réseaux} : gestion des processus, mémoire, concurrence, architecture des ordinateurs, synchronisation, protocoles ;
    \item \textbf{Projets pratiques et études de cas} : conception et encadrement de mini-projets, TD et TP.
\end{itemize}

\noindent
Mon expérience d'enseignement, acquise en école d'ingénieur, en IUT (ainsi qu'au sein de Thales), me permet d'adapter les contenus et méthodes pédagogiques à différents niveaux et profils d'étudiants. Par exemple, en IUT, j'insiste davantage sur les applications pratiques et les compétences techniques essentielles, tandis qu'en école d'ingénieur, je peux approfondir les concepts théoriques.
...
\begin{longtable}{p{6cm} p{4cm} p{4cm}}
    ...
    \textbf{Total TD}     & 39.5 h              & 39.5 hEqTD           \\
    \midrule
    \textbf{Total TP}     & 46.5 h              & 46.5 hEqTD           \\
    \midrule
    \textbf{Total Projet} & 2 h                 & 2 hEqTD              \\
\end{longtable}
...
\begin{landscape}
    ...
    \begin{longtable}{%
        ...
        \href{https://chamilo.grenoble-inp.fr/courses/ESISAR3AMIN333/document/site/index.html}{Lien maquette}                                                                \\
        ...
        $\sim 25 \times 5$                                                                                                                                                 &
        TP                                                                                                                                                                 &
        Enseignement au cours de séances de TP (programmation système, processus, mémoire), accompagnement technique, correction des compte rendus et évaluation continue. &
        \href{https://chamilo.grenoble-inp.fr/courses/ESISAR3AMIN333/document/site/index.html}{Lien maquette}                                                                \\
        ...
        $\sim 20 \times 3$                                                                                                                                                 &
        TP                                                                                                                                                                 &
        Enseignement au cours de séances de TP pour étudiants ingénieurs de 3e année, assistance technique et correction des comptes rendus.                               &
        \href{https://esisar.grenoble-inp.fr/fr/formation/syst-egrave-mes-d-exploitation-3amos302}{Lien maquette}                                                            \\
        ...
        \href{https://esisar.grenoble-inp.fr/fr/formation/conferences-et-veille-technologique-en-cybersecurite-5ampx511}{Lien maquette}                                      \\
    \end{longtable}
    ...
    \begin{longtable}{%
        ...
        2022--2023                                                                                                                                                         &
        L1                                                                                                                                                                 &
        Administration système et fondamentaux de la virtualisation (Dép. \textit{Réseaux et Télécomunications})                                                           &
        7.5 h                                                                                                                                                              &
        7.5                                                                                                                                                                &
        $\sim 20 \times 2$                                                                                                                                                 &
        TD/TP                                                                                                                                                              &
        ...
        \href{https://intranet.iut-valence.fr/unepersonne/fourtyn?path=referentiel-formation-RT_Cyber_BUT.pdf#page=32}{Lien maquette}                                        \\

        \midrule

        2024--2025                                                                                                                                                         &
        L1                                                                                                                                                                 &
        Structuration et traitement de l'information (Dép. \textit{Gestion des entreprises et des administrations})                                                        &
        24 h                                                                                                                                                               &
        24                                                                                                                                                                 &
        $\sim 30 \times 2$                                                                                                                                                 &
        TD/TP                                                                                                                                                              &
        ...
        \href{https://raievskc.gitlab.io/enseignement/BUTInfo/OS/OSBUTInfo.html}{Lien site}                                                                                  \\

        \midrule

        2024--2025                                                                                                                                                         &
        L2                                                                                                                                                                 &
        Programmation système (Dép. \textit{Informatique})                                                                                                                 &
        16.5 h                                                                                                                                                             &
        16.5                                                                                                                                                               &
        $\sim 25 \times 1$                                                                                                                                                 &
        TD/TP                                                                                                                                                              &
...
\noindent
Mes activités de recherche se sont développées principalement dans le cadre de ma thèse CIFRE au \textbf{LCIS} (Grenoble-INP -- UGA, Valence) et chez \textbf{Thales Land and Air Systems} (\textquote{La Ruche}, Rennes).
Ma thèse s'inscrit dans un contexte où la Cyberdéfense fait face à de nombreux défis : multiplicité des menaces, distribution spatiale des systèmes, nécessité d'une réaction rapide et coordonnée face à des attaques sophistiquées où les approches centralisées ou basées sur des règles se révèlent insuffisantes. Ma thèse porte sur l'automatisation de la détection et de la réponse aux cybermenaces en exploitant les SMA et le MARL. La question centrale était de concevoir des SMA de Cyberdéfense robustes, explicables et contrôlables. Pour y répondre, j'ai proposé d'intégrer des contraintes organisationnelles explicites issues du modèle $\mathcal{M}OISE^+$ au sein des algorithmes MARL, créant ainsi un pont entre modélisation formelle et apprentissage automatique afin de guider la convergence vers des comportements collectifs stables et interprétables. Les travaux combinent une dimension méthodologique (modélisation organisationnelle, définition de cadres d'analyse) et une dimension expérimentale (simulation, évaluation de comportements dans des scénarios de Cyberdéfense).
...
\begin{itemize}[leftmargin=1.5em]
    \item[\textbf{\textcolor{SectionColor}{1.}}] \begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
            ...
            \item[] \textbf{Preuve existence publication} : En cours de publication (lettre d'acceptation et rapports des relecteurs fournis avec l'article).
...
\begin{enumerate}[leftmargin=1.5em]
    ...
    \item \begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
              \item[] \textbf{Sujet} : Relectures pour les conférences AAMAS (3 articles), ICAART (3 articles), SMC (2 articles) et ICDL (1 article) ainsi que JFSMA (2 articles) et RESSI (1 article)
    ...
    \item \begin{itemize}[leftmargin=0.1em, itemsep=-2pt, topsep=0pt]
              ...
              \item[] \textbf{Résultat} : Le groupe AICA IWG succède au groupe de recherche IST-152 (OTAN) rassemblant des chercheurs et ingénieurs intéressés par l'automatisation de la Cyberdéfense. Mon rôle consiste principalement à assurer le suivi des aspects administratifs : gestion des adhésions, échanges avec les membres, mise à jour des informations financières et participation aux réunions de pilotage du groupe. Cette activité demande une coordination régulière avec les autres membres du bureau lors de réunions une fois toutes les deux semaines.
          \end{itemize}
