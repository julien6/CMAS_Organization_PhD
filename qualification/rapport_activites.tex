...
%     \item \textbf{Thématique} : structuration du processus de conception de SMAs opérationnels confrontés à des scénarios hostiles.
...
%     \item \textbf{Utilisateurs cibles} : chercheurs travaillant sur les SMAs et ingénieurs impliqués dans l'étude de scénarios cyber.
% \end{itemize}
...
% \begin{itemize}
%     \item \textbf{CybMASDE} : plateforme complète pour la modélisation, l'apprentissage et l'analyse de SMAs.
...
%     \item des chercheurs du LCIS spécialisés dans la modélisation organisationnelle et les SMAs ;
...
\subsubsection*{Activités d'animation scientifique}
