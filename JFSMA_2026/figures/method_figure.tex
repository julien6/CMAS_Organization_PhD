...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    \draw (484.5,3673.53) node   [align=left] {$\displaystyle  \begin{array}{{>{\displaystyle}l}}
            ...
            \end{array}$};
    % Text Node
    \draw (227,3595) node [anchor=north west][inner sep=0.75pt]   [align=left] {Régularisation};
    % Text Node
    ...
    % Text Node
    \draw (242,3922) node [anchor=north west][inner sep=0.75pt]   [align=left] {Résiduel};
    % Text Node
    ...
    % Text Node
    \draw (140.77,4152.5) node  [font=\small] [align=left] {caractéristiques determinable};
    % Text Node
    \draw (146.26,4115.5) node  [font=\small] [align=left] {caractéristiques indéterminables};
    % Text Node
    ...
    % Text Node
    \draw (458.97,4146.55) node  [font=\small] [align=left] {prédit neuronalement};
    % Text Node
    \draw (464,4109.5) node  [font=\small] [align=left] {prédit symboliquement};
