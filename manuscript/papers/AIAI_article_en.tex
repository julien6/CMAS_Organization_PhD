...
\begin{itemize}
    ...
    \item \textquote{Pistonball} (PBL)~\cite{terry2020pettingzoo} consists of a series of pistons to bring a ball from right to left side hence requiring neighbors' representation;
    ...
    \item \textquote{Knights Archers Zombies}~\cite{terry2020pettingzoo} (KAZ) consists in knights and archers learning how to kill zombies hence requiring efficient agent spatial positioning.
\end{itemize}
%
\begin{figure}[H]
    \centering
