...
\begin{algorithm}[H]
    ...
    \tcp*[l]{1) Activité de modélisation}
    ...
    \tcp*[l]{2) Activité d'apprentissage}
    $\pi^{j}_{i} \gets \texttt{train}(d_i, \mathcal{MM}_i)$

    \tcp*[l]{3) Activité d'analyse (optionnelle mais recommandée)}
    ...
    \textbf{retour} à la \textbf{activité de modélisation (1)}
    }
    }

    \tcp*[l]{4) Activité de transfert}
...
Formellement, cette activité met en œuvre la relation :
\[
...
\subsubsection{Activité 3 : Analyse}
