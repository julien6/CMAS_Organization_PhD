...
En résumé, les approches symboliques (basées sur des modèles explicites comme \phantom{XXXX} \acn{Dec-POMDP}) apportent de l'explicabilité et du contrôle, tandis que les approches connexionnistes (basées sur les World Models) favorisent l'adaptation et la performance.
...
\begin{itemize}
  ...
  \item une méthode flexible, utilisable en mode manuel (\acn{TEMM}) pour l'analyse experte, ou automatisée (\acn{Auto-TEMM}).
\end{itemize}
