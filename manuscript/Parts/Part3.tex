...
\begin{algorithm}[H]
  ...
  \KwIn{Environnement initial $\mathcal{E}$, objectif $\mathcal{G}_{\text{inf}}$, contraintes de conception $\mathcal{C}_{\text{inf}}$, nombre maximal de cycles de raffinement $n_{refine}$}
  ...
  \While{le SMA est en cours de conception}{
...
\begin{algorithm}[H]
  ...
  \vspace{0.5em}
  \tcp{2. Entraîner les auto-encodeurs pour les observations et actions conjointes}
