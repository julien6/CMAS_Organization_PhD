...
\medskip
\noindent
\textbf{P2 -- Résolution sous contraintes}
...
\begin{itemize}
  ...
  \item \textbf{H-TRN~:} Il est possible d'obtenir une politique conjointe via le \acn{MARL} et d'y intégrer les exigences de conception en tant que spécifications organisationnelles dans le processus d'apprentissage pour améliorer la conformité et la sûreté des politiques apprises.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{
    ...
    (Obtenir un environnement crédible et adaptable)
                                                                                                                          &
    P1 : Modélisation réaliste de l'environnement
                                                                                                                          &
    ...
    (Optimiser la performance sous contraintes organisationnelles)
                                                                                                                          &
    P2 : Résolution sous contraintes
                                                                                                                          &
    ...
    (Expliciter et vérifier les comportements organisationnels)
                                                                                                                          &
    P3 : Analyse et explicabilité des comportements
                                                                                                                          &
    ...
    (Assurer la cohérence et l'adaptation entre simulation et réalité)
                                                                                                                          &
    P4 : Déploiement et transfert vers le réel
                                                                                                                          &
...
\end{itemize}
Cette décomposition conduit à identifier quatre sous-problèmes fondamentaux, correspondant aux objectifs de chaque activité~: (P1) la modélisation réaliste de l’environnement, (P2) la résolution sous contraintes, (P3) l’analyse et l’explicabilité des comportements, et (P4) le déploiement et le transfert vers le réel. Pour chacun de ces sous-problèmes, nous avons formulé des hypothèses de recherche (H-MOD, H-TRN, H-ANL, H-TRF) qui délimitent l’espace d’investigation et orientent la suite du manuscrit.
