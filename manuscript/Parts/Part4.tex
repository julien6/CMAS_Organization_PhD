...
L'un des apports essentiels de \acn{CybMASDE}\footnotemark[1] est d'intégrer le cadre organisationnel MOISE+ aux méthodes d'apprentissage multi-agents. Pour cela, nous avons développé une implémentation Python appelée \textbf{MMA} (\textit{MOISE+MARL API})\footnotemark[2].
