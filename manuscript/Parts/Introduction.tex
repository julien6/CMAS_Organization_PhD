...
\cleardoublepage
\phantomsection
% \pdfbookmark[1]{INTRODUCTION GENERALE}{INTRODUCTION GENERALE}
\addcontentsline{toc}{part}{INTRODUCTION GENERALE}
\markboth{\spacedlowsmallcaps{INTRODUCTION GENERALE}}{\spacedlowsmallcaps{INTRODUCTION GENERALE}}
\noindent {\LARGE\textbf{INTRODUCTION GENERALE}}
...
%
Plutôt que de chercher une solution de \acn{SMA} de Cyberdéfense unique pour répondre à ce problème complexe, nous visons à établir une méthode de conception pour guider ou assister le processus de création d'un tel \acn{SMA}. Cette méthode se veut générique et capable d'intégrer, organiser et orchestrer les différentes contributions de manière cohérente.
...
\noindent
Nous cherchons à établir une méthode de conception de \acn{SMA} pour des \acplu{SMA} de Cyberdéfense. En supposant la simulation nécessaire, notre méthode peut être abordée en quatre activités~:
\begin{itemize}
...
\begin{figure}[h!]
  ...
  \resizebox{0.8\textwidth}{!}{%
    \input{figures/manuscrit_raisonnement}
  }
...
%
Dans la continuité, la \fullpartref{part:methode}{La méthode MAMAD} décrit la méthode \acn{MAMAD}~\cite{soulej2025jaamas}, conçue pour répondre à la question de recherche. Elle en détaille les quatre activités clés et explicite les contributions spécifiques associées à chacune.
%
...
\begin{figure}[h!]
  \centering
  \resizebox{\textwidth}{!}{%
    \input{figures/organisation_manuscrit}
  }
