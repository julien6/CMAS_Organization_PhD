...
%
Dans la continuité, la \fullpartref{part:methode}{La méthode MAMAD} décrit la méthode \acn{MAMAD}~\cite{soule2024marl}, conçue pour répondre à la question de recherche. Elle en détaille les quatre activités clés et explicite les contributions spécifiques associées à chacune.
%
