\resizebox{\textwidth}{!}{%
  \begin{tikzpicture}[
    ...
    \node[chapter, below= of c6, xshift=-6cm] (c7) {Chapitre 7 : Modélisation en simulation};
    \node[chapter, below=of c7] (c8) {Chapitre 8 : Apprentissage guidé/contraint};
    \node[chapter, below=of c8] (c9) {Chapitre 9 : Analyse post-entraînement};
    \node[chapter, below=of c9] (c10) {Chapitre 10 : Transfert et supervision};
    ...
    \draw[arrow] (c10.east) -- ++(1.65,0) -- ($ (c6.south) + (-0.35,0) $);

    \draw[arrow] (c6.south) -- ++(0,0) |- (c11.east);

    \draw[arrow] (c11.south) -- ++(0,0) |- (c12.west) node[annotated] {Support protocole expérimental};
