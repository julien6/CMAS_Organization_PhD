\resizebox{\textwidth}{!}{%
  \begin{tikzpicture}[
    ...
    \draw[arrow] (c3) -- (c4) node[annotated] {Identification des verrous pour chaque hypothèse};
    \draw[arrow] (c4) -- (c5) node[annotated] {Précision des fondations théoriques retenues};
    \draw[arrow] (c5) -- (c6) node[annotated] {Assemblage en une méthode pour répondre aux verrous};
