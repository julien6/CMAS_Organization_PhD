\resizebox{\textwidth}{!}{%
  \begin{tikzpicture}[
    ...
    \node[chapter, below=of c1] (c2) {Chapitre 2 : Vers des approches multi-agents de cyberdéfense};
    \node[chapter, below=of c2] (c3) {Chapitre 3 : D'un problème d'ingénierie à un problème d'optimisation};

    \node[chapter, below=of c3] (c4) {Chapitre 4 : Les SMA et concepts théoriques mobilisés};
    \node[chapter, below=of c4] (c5) {Chapitre 5 : Les verrous vers une méthode de conception};
    ...
    \draw[arrow] (c2) -- (c3) node[annotated] {Paradigme d'optimisation avec sous-problèmes};
    ...
    \node[chapter, below=of c7] (c8) {Chapitre 8 : Apprendre des politiques sous contraintes};
