...
Les travaux scientifiques se répartissent selon plusieurs axes complémentaires~\cite{Buczak2016} :
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{organisés en swarms}, communiquent et coordonnent des vecteurs d'attaque parallèles — décrits dans les modèles de multi-agents adverses~\cite{MultiAgentAttackDefense2025};
...
\begin{figure}[h]
    ...
    \fbox{\begin{minipage}[c][5.5cm][c]{0.8\textwidth}
        \centering
        \textit{Comparaison entre organisation imposée (top-down) et auto-organisation (bottom-up)}
    \end{minipage}}
