...
% \begin{itemize}
%     \item \textbf{Phase 1 : Modélisation en simulation} (P1, H1/H2), où nous développons des techniques d'apprentissage de dynamique d'environnement, de reconstruction partielle d'états et d'Modélisation des exigences de conception et de l'objectif.
...
Afin de structurer cette revue, nous évaluons chaque approche au regard des dix critères (C1 à C10) définis précédemment (voir section~\autoref{sec:problematique-sma-aica}). Ces critères recouvrent des exigences de compatibilité avec la philosophie AICA (C1), de résilience (C2), de capacité d'auto-organisation (C3), d'automatisation (C6), d'explicabilité (C7), etc.
