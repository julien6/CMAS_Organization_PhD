...
% - TODO : Il faut que la première section soit plus longue, parle un peu plus des définitions de Cybersécurité et Cyberdéfense. Il faut mieux expliquer tous les concepts et les bases de la Cyberdéfense afin que tout le monde puisse comprendre ce qu'est le travail de quelqu'un qui fait de la recherche en Cyberdéfense / Cybersécurité (pentester, opérateur SOC, chercheur, etc). Il ne faut pas encore parler explicitement des limites actuelles de la Cyberdéfense/Cybersécurité. Il ne faut pas parler encore des agents AICA car on en parlera après.

% - TODO : Dans la section 1.2, quand on parle des agents AICA pour la première fois, il faut y consacrer un grand nombre de paragraphes et de figures importantes qui s'inscrivent dans la section.

% - TODO : Dans la section 1.3, 
