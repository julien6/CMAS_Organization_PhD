...
% TODO : Faire une introduction générale
Hello !

\part{Construire le cadre du problème}
...
\subsection{Du problème d'optimisation à une démarche d'ingénierie multi-agent}
...
\subsection{Articuler les contributions dans une méthode intégrée}
...
\subsection{Construire une méthode généralisable et réutilisable}
...
\section{SMA et modèles organisationnels : MOISE+}
...
\section{Les principes et la boucle itérative}
