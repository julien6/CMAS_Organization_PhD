...
%     \acl{#1}%
%   \else
%     % On teste si \ac a déjà été utilisé pour #1
%     \expandafter\ifx\csname ac@#1\endcsname\AC@used
%       \acs{#1}% → déjà utilisé : on affiche juste l’acronyme
%     \else
%       \acl{#1} -- \acs{#1}% → première occurrence : nom complet + acronyme
%       \global\expandafter\let\csname ac@#1\endcsname\AC@used % on marque comme "used"
%     \fi
%   \fi
% }
% \makeatother
