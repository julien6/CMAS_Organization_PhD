...
\section{Évolution des menaces, défis et besoins en cyberdéfense autonome et émérgence d'une approche distribuée et décentralisée de la Cyberdéfense}
...
\section{Définitions, concepts et panorama de la recherche sur les SMA}
...
\section{La problématique de la conception d'un SMA de Cyberdéfense auto-organisé de type AICA}
...
\section{Intégration organisation-apprentissage}

\chapter{Analyse des hypothèses : état de l’art, verrou, formulation}
...
\chapter{MAMAD comme réponse intégrée}
\section{Principe général et boucle itérative}
\section{Architecture globale}

\chapter{Phase 1 — Modélisation}
...
\chapter{Phase 2 — Apprentissage guidé (MARL contraint)}
...
\chapter{Analyse croisée des contributions}
\section{Conditions de validité et généralité}
\section{Positionnement dans l’écosystème de recherche}
