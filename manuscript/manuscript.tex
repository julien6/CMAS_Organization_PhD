...
\begin{figure}[H]
    \centering
    \fbox{
        \begin{minipage}[c][4.5cm][c]{0.9\linewidth}
            \centering
            \textit{Illustration à insérer : Schéma illustrant le cycle de la cyberdéfense (Prévention – Détection – Réaction – Récupération – Résilience)}
        \end{minipage}
    }
...
\begin{figure}[H]
    ...
    \fbox{
        \begin{minipage}[c][5cm][c]{0.9\linewidth}
            \centering
            \textit{Illustration à insérer : Taxonomie des axes de recherche en cyberdéfense, organisée en catégories (détection, réaction, résilience...)}
        \end{minipage}
    }
...
\begin{figure}[H]
    ...
    \fbox{
        \begin{minipage}[c][4.2cm][c]{0.9\linewidth}
            \centering
            \textit{Illustration à insérer : Comparaison visuelle entre cyberdéfense centralisée et approche multi-agent décentralisée, avec avantages/inconvénients}
        \end{minipage}
    }
