...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    \draw (187.23,2773.35) node  [font=\scriptsize] [align=left] {\begin{minipage}[lt]{8.67pt}\setlength\topsep{0pt}
            \begin{center}
                {\scriptsize \textbf{\textcolor[rgb]{0.82,0.01,0.11}{?}}}
            \end{center}
    ...
    \draw (336,2940) node   [align=left] {\begin{minipage}[lt]{62.53pt}\setlength\topsep{0pt}
            \begin{center}
                \textit{{\footnotesize "indices" de}\\{\footnotesize SMA suggerés}}
            \end{center}
    ...
    \draw (139.36,2940.19) node   [align=left] {\begin{minipage}[lt]{96.97pt}\setlength\topsep{0pt}
            \begin{center}
                \textit{{\footnotesize Env. simulé + Agents entraînés}}
            \end{center}
    ...
    \draw (138.5,2824.5) node  [font=\footnotesize] [align=left] {\begin{minipage}[lt]{93.02pt}\setlength\topsep{0pt}
        ...
        \end{minipage}};
    % Text Node
    \draw (171.5,2848.5) node  [font=\footnotesize] [align=left] {\scriptsize \textbf{2) Entrainement}};
    % Text Node
    \draw (357.3,2848.5) node  [font=\footnotesize] [align=left] {\scriptsize \textbf{4) Transfert}};
    % Text Node
    ...
    \draw (305.3,2886.5) node  [font=\scriptsize] [align=left] {\begin{minipage}[lt]{8.67pt}\setlength\topsep{0pt}
        ...
        \end{minipage}};
    % Text Node
    \draw (236.43,2889.27) node  [font=\footnotesize] [align=left] {\scriptsize \textbf{3) Analyse}};
    % Text Node
    \draw (233.5,2792.5) node  [font=\footnotesize] [align=left] {\scriptsize \textbf{1) Modélisation}};
