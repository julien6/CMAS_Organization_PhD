...
\begin{frame}{Understanding the postdoc topic: objectives}
    ...
    \textbf{My reading of the project objectives}

    \vspace{0.2cm}
    \begin{itemize}
        \item Design an \textbf{AI-assisted orchestration layer} for attack surface assessment tools.
        \item Support analysts in:
              \begin{itemize}
                  \item deciding which tools to use,
                  \item selecting configurations and scopes,
                  \item interpreting heterogeneous outputs.
              \end{itemize}
        \item Aggregate discovered information into \textbf{structured representations}.
        \item Provide \textbf{prioritized and explainable outputs} usable in operational contexts.
    \end{itemize}

    \vspace{0.3cm}
    \textbf{Positioning}
    \begin{itemize}
        \item AI as a \textbf{support to expert reasoning}, not a replacement.
        \item Emphasis on robustness, traceability, and analyst trust.
    \end{itemize}
\end{frame}
...
\begin{frame}{Understanding the postdoc topic: proposed workflow}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.6\textwidth}
            \vspace{1cm}
            \begin{itemize}
                \item The postdoc focuses on \textbf{orchestration and coordination},
                      not on replacing existing tools
                \item AI techniques act as \textbf{decision and guidance mechanisms}
                      within an iterative assessment loop
                \item The final objective is a consolidated and interpretable
                      view of the external attack surface
            \end{itemize}
        \end{column}
    \end{columns}
...
\begin{frame}{Indicative postdoc plan (open proposal)}
    ...
    \vspace{0.2cm}
    \begin{itemize}
        \item Iterative refinement with empirical feedback.
        \item Continuous interaction with domain experts.
    \end{itemize}
\end{frame}
