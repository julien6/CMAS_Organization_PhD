...
% \input{tables/organizational_models}
...
\begin{itemize}
    ...
    \item \textquote{Pistonball} (PBL)~\cite{terry2020pettingzoo} se compose d'une série de pistons pour amener une balle de droite à gauche, nécessitant ainsi la représentation des voisins ;
    ...
    \item \textquote{Knights Archers Zombies}~\cite{terry2020pettingzoo} (KAZ) consiste en trois chevaliers et deux archers apprenant à tuer le plus de zombies, ce qui nécessite ainsi un positionnement spatial efficace des agents.
\end{itemize}
...
\input{tables/training_OMARL_results}
...
%
\input{tables/trained_OMARL_results}
%
